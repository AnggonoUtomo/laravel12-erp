...
class ActivityCentersArchitectureTest extends TestCase
{
    public function test_activity_centers_uses_target_routes_without_changing_its_public_route_contract(): void
    {
        $path = app_path('Modules/Console/ActivityCenters');
        ...
        $this->assertFileExists($path.'/Presentation/Http/Controllers/ActivityCenterController.php');
        $this->assertFileExists($path.'/Application/Services/ActivityCenterService.php');
