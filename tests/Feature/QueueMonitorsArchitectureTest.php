...
class QueueMonitorsArchitectureTest extends TestCase
{
    public function test_queue_monitors_uses_target_routes_without_changing_its_public_route_contract(): void
    {
        $path = app_path('Modules/Console/QueueMonitors');
        ...
        $this->assertFileExists($path.'/Presentation/Http/Controllers/QueueMonitorController.php');
        $this->assertFileExists($path.'/Application/Services/QueueMonitorService.php');
